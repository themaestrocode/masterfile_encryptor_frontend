...
function decryptFile(fileDecryptionObject) {
   ...
   const urlString = "https://masterfileencryptorapi.onrender.com/api/v1/decrypt-file";
...
function decryptText(textDecryptionObject) {
   ...
   const urlString = "https://masterfileencryptorapi.onrender.com/api/v1/decrypt-text";
